  <div class="container-fluid">
      ...
      <div class="card-body">
    <button class="btn btn-sm btn-primary mb-3" data-toggle="modal" data-target="#inputpsModal"><i class="fas fa-plus-circle fa-sm" ></i> Input User Baru</button>
         ...
         ?>
          ...
          <tr>
           ...
           <td><?php echo $us->nama ?></td>
             ...
             <td><center><?php if($us->role_id==1){
 						echo '<span class="badge badge-primary">Admin</span>';}
 						elseif($us->role_id==2) { echo '<span class="badge badge-danger">User</span>';}
 						else{echo '<span class="badge badge-success">H R D</span>';}?></center></td>
             <td><center><a href="<?= base_url('klinik/kary') . $us->id ;?>" class="badge badge-success"><i class="fa fa-eye"></i></a>
              <a href="" class="badge badge-primary"><i class="fa fa-edit"></i></a>
              <a onclick="return confirm('apakah anda yakin?')" href="<?= base_url('klinik/kary/hapus/') . $us->id ;?>" class="badge badge-danger"><i class="fa fa-trash"></i></a>
            </center></td>
           </tr>
