	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?php echo base_url(). 'klinik/injury/tambah';?>" method="post">
					<input type="hidden" id="tgl" name="tgl" value="<?php echo date('Y-m-d');?>">
						<div class="form-group row">
							<label class="col-sm-3 col-form-label">NIK</label>
							<div class="col-md-5">
								<input name="nik" type="text" id="nik" class="form-control" placeholder="Nomor Induk Kary" value="">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 col-form-label">Bagian Luka</label>
							<div class="col-md-9">
								<textarea class="form-control" id="bag_luka" name="bag_luka" placeholder="Bagian Tubuh Yang Luka"></textarea>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-3 col-form-label">T4, Deskripsi</label>
							<div class="form-group col-md-9">
								<textarea class="form-control" id="t4_deskripsi" name="t4_deskripsi" placeholder="Tempat Kejadian dan Deskripsi Kecelakaan"></textarea>
							</div>
						</div>
					<div class="form-group row">
						<label class="col-sm-3 col-form-label">Tindakan</label>
						<div class="col-sm-9">
							<textarea class="form-control" id="tindakan" name="tindakan" placeholder="Tindakan Yang Dilakukan" required></textarea>
						</div>
					</div>
					<div class="form-group row">
                    ...
                    <label class="col-sm-3 col-form-label">Kriteria</label>
                        <div class="col-sm-6">
                        <select class="custom-select mr-sm-4" id="inlineFormCustomSelect" name="criteria">
