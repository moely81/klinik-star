         ...
         ?>
          ...
          <tr>
           ...
           <td><?php echo $ps->nama ?></td>
             ...
             <td><center><a href="<?= base_url('klinik/ps/detail_ps/') . $ps->id ;?>" class="badge badge-success"><i class="fa fa-eye"></i></a>
              <a class="badge badge-primary" data-toggle="modal" 
              data-target="#editpsModal<?php echo $ps->id;?>"><i class="fa fa-edit"></i></a>
              <a onclick="return confirm('apakah anda yakin?')" href="<?= base_url('klinik/ps/hapus/') . $ps->id ;?>" class="badge badge-danger"><i class="fa fa-trash"></i></a>
            </center></td>
           </tr>
