 ...
 <?= $this->session->flashdata('message');?>
 	<a href="<?php echo base_url('klinik/absill_verified');?>" class="btn btn-sm btn-primary mb-3"><i class="fas fa-check fa-sm" ></i> Verified</a>
...
<script>
 $(function() {
  $( "#tgskt1" ).datepicker({ dateFormat: 'yy-mm-dd', minDate: 0, maxDate: "+1W +0D" }).val();
 });
</script>