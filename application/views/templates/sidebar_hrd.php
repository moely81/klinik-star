        ...
        <li class="nav-item">
          ...
          <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="<?php echo base_url('hrd/absill')?>">Absen Illness</a>
              <a class="collapse-item" href="<?php echo base_url('hrd/injury')?>">Absen Injury</a>
            </div>
          </div>
        </li>
          ...
          <li class="nav-item">
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php echo base_url ('report/absill_hrd')?>">Absen Illness</a>
                <a class="collapse-item" href="">Absen Injury</a>
