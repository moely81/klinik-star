 ...
 <?= $this->session->flashdata('message');?>
 				<form action="<?php echo base_url('user/absill/tambah')?>" method="post">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control form-control-sm" id="alamat" name="alamat" placeholder="Alamat Dokter">
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-sm-6">
							<input type="date" class="form-control form-control-sm" id="tgskt1" name="tgskt1">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-3 col-form-label">Tgl Akhir</label>
						<div class="col-sm-6">
							<input type="date" class="form-control form-control-sm" id="tgskt2" name="tgskt2" placeholder="">
						</div>
					</div>
					<div class="form-group row">
