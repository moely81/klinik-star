...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div id="laporanPage">
            <form class="form-horizontal" method="post" action="<?= base_url('report/absill/cari');?>">
                <div class="row ml-3">
                ...
                <div class="form-group mt-4">
                    <div class="form-controls">
                        <button id="btnCari" type="button" class="btn btn-sm btn-info"><i class="fas fa-search mr-2"></i> Search...</button>
                    </div>
                </div>
                </div>
            </form>
...
<tbody>
    <th>
        ...
        <td></td>
    <tr>
        <th colspan="4"><center>Lost Working Day </center></th>
        <th colspan="1"><center></center></th>
    </tr>
    <tr>
        <th colspan="4"><center>Lost Time Sick </center></th>
        <th colspan="1"><center></center></th>
    </tr>
    <tr>
        <th colspan="4"><center>Non Effective Rate Illness </center></th>
        <th colspan="1"><center></center></th>
    </tr>
    </th>
</tbody>    
