...
class Injury extends CI_Controller{
	...
	public function index()
	{
		...
		$this->load->view('klinik/injury', $data);
	...
	public function tambah(){    
		...
		$bag_luka	    = $this->input->post('bag_luka');      
		$t4_deskripsi	= $this->input->post('t4_deskripsi');      
