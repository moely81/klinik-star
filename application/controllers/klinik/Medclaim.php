...
class Medclaim extends CI_Controller{
	...
	public function index()
	{
		...
		$data['title'] = 'Data Medclaim';
		$data['medclaim'] = $this->model_app->get_medclaim();
		
		$this->load->view('templates/header', $data);
		$this->load->view('templates/sidebar', $data);
		$this->load->view('klinik/medclaim', $data);
