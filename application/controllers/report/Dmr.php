...
class Dmr extends CI_Controller{
	...
	function cari(){
		...
		$data=array(
			'dt_result'=> $this->model_app->getReport_dmr($tgl_awal,$tgl_akhir),
		...
		$this->load->view('report/result_dmr',$data);
	}
}
?>