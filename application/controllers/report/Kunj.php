...
class Kunj extends CI_Controller{
	...
	public function index()
	{
		...
		$this->load->view('report/kunj', $data);
	...
	function cari(){
		...
		$data=array(
			'dt_result'=> $this->model_app->getReport_kunj($tgl_awal,$tgl_akhir),
		...
		$this->load->view('report/result_kunj',$data);
	}
}
?>