...
class Absill extends CI_Controller{
	...
	public function index()
	{
		...
		//$limit = 8;
		//$jumlah_data_absill = $this->model_app->jumlah_data_absill();
		//$config['base_url'] = 'https://klinikstar.online/user/absill/index';
		...
		$data['absill'] = $this->model_app->get_absill_user()->result();
		$data['title'] = 'Absill';
		
		$this->load->view('templates/header', $data);
		$this->load->view('templates/sidebar_user', $data);
		$this->load->view('user/absill', $data);
